...
const kurikulum = [
  ...
  },
  {
    ...
    link:[
	    {
	    	title : '2. Cara alami menguasai bahasa inggris semudah bahasa Indonesia',
	    	time : "00:02:00"
	    },
	     {
  ...
  },
  {
    ...
    link:[
	    {
	    	title : '5. Cara alami menguasai bahasa inggris semudah bahasa Indonesia',
	    	time : "00:05:00"
	    },
	     {
  ...
  },
  {
    ...
    link:[
	    {
	    	title : '7. Cara alami menguasai bahasa inggris semudah bahasa Indonesia',
	    	time : "00:07:00"
	    },
	     {
  ...
  },
  {
    ...
    link:[
	    {
	    	title : '9. Cara alami menguasai bahasa inggris semudah bahasa Indonesia',
	    	time : "00:09:00"
	    },
	     {
  ...
  const handleChange = (panel) => (event, isExpanded) => {
	...
	return(
		<React.Fragment>
              ...
              style={{ borderRadius: '7px', border: "0.7px solid rgba(28, 29, 32, 0.128961)", margin: ".3rem 0", boxShadow: "0px 3px 6px rgba(28, 29, 32, 0.0485686)"}}
              key={index}
            >
              <AccordionSummary
                ...
                id={item.id}
              >
                <p style={{ margin: 0, lineHeight: "1.5", fontWeight: "600" }}>{item.judul}</p>
              </AccordionSummary>
              <AccordionDetails>
              	<Grid container>
